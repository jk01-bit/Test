...
class ZerodhaBroker:
    ...
    def place_spread_order(
        ...
        try:
            # Place BUY order FIRST (hedge protection for margin benefit)
            ...
            # Place SELL order SECOND (after hedge is in place)
            ...
            if not sell_order_id:
                logger.error("SELL order failed - BUY already executed, manual intervention needed")
                return None, buy_order_id
